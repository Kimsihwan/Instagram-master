...
import com.example.test.instagram.Utils.Conv;
...
public class LikesActivity extends AppCompatActivity {
    ...
    private DatabaseReference mUsersSetting;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mUsersSetting = FirebaseDatabase.getInstance().getReference().child("users_account_settings");
        ...
        FirebaseRecyclerAdapter<Conv, ConvViewHolder> firebaseConvAdapter = new FirebaseRecyclerAdapter<Conv, ConvViewHolder>(
            ...
            protected void populateViewHolder(final ConvViewHolder convViewHolder, final Conv conv, int i) {
                ...
                Query lastMessageQuery = mMessageDatabase.child(list_user_id).limitToLast(1);
                    ...
                    mUsersSetting.child(list_user_id).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            String userThumb = dataSnapshot.child("profile_photo").getValue().toString();

                            convViewHolder.setUserImage(userThumb, mContext);
                        }
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            convViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    Intent chatIntent = new Intent(LikesActivity.this, ChatActivity.class);
